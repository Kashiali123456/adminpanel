<div class="package-slide owl-carousel owl-theme content-writing-package">
	<?php
		$fetch=mysqli_query($con,"select * from packages where package_name='CONTENT WRITING' order by package_sell_price ASC");
	    $check = 0;
		while ($row=mysqli_fetch_assoc($fetch)) {
		          $content[] = $row;
        }
        $val = array_shift($content);
        array_push($content, $val);
	...
	<div class="slide-item">
		...
		<div class="package-middle-box package-middle-box-blue">
			...
			<div class="package-bottom">
				<button class="package-bottom-btn1"><a href="https://customwebnlogodesigns.com/order/payment" style="color:#000;">ORDER NOW</a></button>

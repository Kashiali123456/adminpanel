<div class="package-slide owl-carousel owl-theme website-package">
	<?php
		$fetch=mysqli_query($con,"select * from packages where package_name='WEBSITE' order by package_sell_price ASC");
	    $check = 0;
		while ($row=mysqli_fetch_assoc($fetch)) {
		          $website[] = $row;
        }
        $val = array_shift($website);
        array_push($website, $val);

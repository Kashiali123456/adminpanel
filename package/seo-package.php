<div class="package-slide owl-carousel owl-theme seo-package">
	<?php
		$fetch=mysqli_query($con,"select * from packages where package_name='SEO' order by package_sell_price ASC");
	   // var_dump($fetch);

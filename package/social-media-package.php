<div class="package-slide owl-carousel owl-theme social-media-package">
	<?php
		$fetch=mysqli_query($con,"select * from packages where package_name='SOCIAL MEDIA MARKETING' order by package_sell_price ASC");

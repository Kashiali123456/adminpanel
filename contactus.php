...
error_reporting(E_ALL);
   $con = mysqli_connect("localhost","techrpsj_customwebnlogodesigns","7j!pp_ab9nAi","techrpsj_customwebnlogodesigns");
	...
	if(isset($_POST['submit']))
	{
		...
		$insert=mysqli_query($con,"INSERT INTO `contact-us`(`name`,`email`,`subject`,`message`)Values('$name','$email','$subject','$message')");
		if($insert)
		{
			echo "You Form has been submited our consultant will contact you soon", "<br>"; 
// 			$subject = "You have received new Message";
			$msg = "Name : ".$name."<br> Email : ".$email."<br> Subject : ".$subject."<br> Message : ".$message;
		     $mail = new PHPMailer;
    // // $mail->isMail();
    $mail->SMTPDebug = 0;
...
?>
<?php header("Location: contactmail"); ?>

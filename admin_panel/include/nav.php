<?php
$login_fetch=mysqli_query($con,"select * from login");
while ($row=mysqli_fetch_array($login_fetch)) {
	if(isset($_SESSION["admin_login"])==$row["email"])
	{
		$login_email=$row['email'];
		$login_username=$row['username'];
		$login_profile=$row['profile_pic'];
	}
	else
	{
		?>
...
<!--sidebar-wrapper-->
		<div class="sidebar-wrapper" data-simplebar="true">
			<div class="sidebar-header">
				<div class="">
					<a href="index"><img src="assets/images/admin-logo.png" width="70%"  alt="" /></a>
				</div>
				<!--<div>
					<h4 class="logo-text">Freelance</h4>
				</div>-->
			...
			<ul class="metismenu" id="menu">
				...
				<li>
					...
					<ul class="mm-collapse">
						<li> <a href="add-packages"><i class="bx bx-right-arrow-alt"></i>Add Packages</a>
						</li>
						<li> <a href="edit-delete-packages"><i class="bx bx-right-arrow-alt"></i>View / Edit / Delete</a>
						</li>
					</ul>
				</li>
			</ul>
							...
							<a class="nav-link dropdown-toggle dropdown-toggle-nocaret" href="javascript:;" data-toggle="dropdown">
								<div class="media user-box align-items-center">
									<div class="media-body user-info">
										<p class="user-name mb-0"><?=$login_username?></p>
										<p class="designattion mb-0">Available</p>
									</div>
									<img src="assets/images/profile.jpg" class="user-img" alt="user avatar">
								</div>
							</a>
							<div class="dropdown-menu dropdown-menu-right">	
								<a class="dropdown-item" href="profile"><i
										class="bx bx-user"></i><span>Profile</span></a>
								<div class="dropdown-divider mb-0"></div>	<a class="dropdown-item logout" href="javascript:"><i

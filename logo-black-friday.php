...
error_reporting(E_ALL);
   $con = mysqli_connect("localhost","techrpsj_customwebnlogodesigns","7j!pp_ab9nAi","techrpsj_customwebnlogodesigns");
	...
	if(isset($_POST['submit']))
	{
		...
		$insert=mysqli_query($con,"INSERT INTO `logo_black_friday`(`name`,`email`,`phone`, `message`)Values('$name','$email','$phone', '$message')");
		if($insert)
		{
...
// 			$subject = "You have received new Message";
    ...
    if (!$mail->send()) {
	  ...
	  exit();
       ...
       echo "Thank you for contacting us. You will get a reply as soon as possible.".$mail -> mail_error;
    }
